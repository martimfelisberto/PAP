        ...
        <div class="search-popup-container">
            ...
            <ul class="cat-list">
                <li class="cat-list-item">
                    <a href="/produtos/casacoshomem" title="Jackets">Casacos</a>
                </li>
                <li class="cat-list-item">
                    <a href="#" title="T-shirts">T-shirts</a>
                </li>
                <li class="cat-list-item">
                    <a href="#" title="Dresses">Camisolas</a>
                </li>
                <li class="cat-list-item">
                    <a href="#" title="Jumpsuits">Calças e Calções</a>
                </li>
            </ul>
                    ...
                    <ul class="navbar-nav gap-md-5">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                                ...
                                <li><a href="/homem/casacos" class="dropdown-item item-anchor">Casacos</a></li>

                                <li><a href="/homem/camisolas" class="dropdown-item item-anchor">Camisolas </a></li>

                                <li><a href="/homem/calcas" class="dropdown-item item-anchor">Calças e Calções</a>
                                </li>
                                <li><a href="/homem/tshirts" class="dropdown-item item-anchor">Tops e t-shirts</a>
                                </li>
                                <li><a href="/homem/sapatilhas" class="dropdown-item item-anchor">Sapatilhas</a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                                ...
                                <li><a href="/mulher/casacos" class="dropdown-item item-anchor">Casacos</a></li>
                                <li><a href="/mulher/camisolas" class="dropdown-item item-anchor">Camisolas </a></li>
                                <li><a href="/mulher/calcas" class="dropdown-item item-anchor">Calças e Calções</a>
                                </li>
                                <li><a href="/mulher/tshirts" class="dropdown-item item-anchor">Tops e t-shirts</a>
                                </li>
                                <li><a href="/mulher/sapatilhas" class="dropdown-item item-anchor">Sapatilhas</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdownBlog"
                            ...
                            <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                                ...
                                <li><a href="/crianca/casacos" class="dropdown-item item-anchor">Casacos</a></li>

                                <li><a href="/crianca/crianca" class="dropdown-item item-anchor">Camisolas </a></li>
                                <li><a href="/crianca/calcas" class="dropdown-item item-anchor">Calças e Calções</a>
                                </li>
                                <li><a href="/crianca/tshirts" class="dropdown-item item-anchor">Tops e t-shirts</a>
                                </li>
                                <li><a href="/crianca/sapatilhas" class="dropdown-item item-anchor">Sapatilhas</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/artigos">Vender</a>
                        </li>
                        ...
                        <li class="nav-item">
                            @guest
                            <a class="nav-link nav-link-box" href="/login">
                                Login
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-box" href="/register">
                                Register
                            </a>
                        </li>
                        @else
