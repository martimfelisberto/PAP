            ...
            <form method="POST" action="{{ route('artigos.store') }}" enctype="multipart/form-data" class="p-6 form-grid">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="descricao" required rows="4" class="w-full p-2 border rounded-md focus:ring focus:ring-blue-300"></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div class="relative">
                            ...
                            <div onclick="toggleDropdown('categoriaDropdown')"
                                ...
                                <span id="selectedCategories">Selecione a categoria</span>
                                <span>▼</span>
                            </div>
                        ...
                        <div>
                            ...
                            <select name="genero" id="generoSelect" class="w-full p-2 border rounded-md focus:ring focus:ring-blue-300" onchange="redirectByGender()">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <!-- Tamanho (Dinâmico) -->
                        <div id="tamanhoContainer" class="hidden">
                        ...
                        <div class="relative">
                            ...
                            <div onclick="toggleDropdown('corDropdown')"
                                class="flex items-center justify-between w-full p-2 bg-white border rounded-md cursor-pointer">
                                <span id="selectedColors">Selecione as cores</span>
                                <span>▼</span>
                            </div>
                            <div id="corDropdown"
                                class="absolute z-10 hidden w-full mt-2 bg-white border rounded-md shadow-md">
                                <div class="p-2 space-y-2">
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" name="cores[]" value="Relógios" class="form-checkbox"
                                            onchange="updateSelectedColors()">
                                        <span>Preto</span>
                                    </label>
                                    <label class="flex items-center space-x-2">
                                        <input type="checkbox" name="cores[]" value="Óculos de Sol"
                                            class="form-checkbox" onchange="updateSelectedColors()">
                                        <span>Branco</span>
                                    </label>
                                </div>
                            </div>
                ...
                <div class="image-preview-container">
                    <label for="imagem" class="flex flex-col items-center cursor-pointer">
                        <div
                            ...
                            <img id="imagePreview" src="https://via.placeholder.com/400"
